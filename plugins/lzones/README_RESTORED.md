...
- Radiation severity now scales by distance to the blast center; blindness was removed, and only light nausea remains after 70% exposure.
- Added radiation armor kit via `/lr give radkit [player]`; a full charged set blocks new radiation exposure until the pieces break.
- Radiation now lasts `700` seconds by default.
