...
public final class Settings {
    ...
    public static Settings load(FileConfiguration config) {
        ...
        NuclearBombSettings nuclearBombSettings = new NuclearBombSettings(Math.max(20, explosiveNuclear.getInt("charge-ticks", 100)), Math.max(8.0, explosiveNuclear.getDouble("blast-radius", 100.0)), Math.max(4.0f, (float)explosiveNuclear.getDouble("explosion-power", 22.0)), Math.max(4, explosiveNuclear.getInt("crater-radius", 24)), Math.max(2, explosiveNuclear.getInt("crater-depth", 8)), Math.max(8.0, explosiveNuclear.getDouble("mushroom-height", 95.0)), Math.max(4.0, explosiveNuclear.getDouble("mushroom-radius", 38.0)), Math.max(6.0, explosiveNuclear.getDouble("radiation-radius", 300.0)), Math.max(5, explosiveNuclear.getInt("radiation-duration-seconds", 240)), Math.max(0.1, explosiveNuclear.getDouble("exposure-per-second", 1.0)), Math.max(0.0, explosiveNuclear.getDouble("safe-decay-per-second", 0.35)), Math.max(1.0, explosiveNuclear.getDouble("damage-threshold", 12.0)), Math.max(0.1, explosiveNuclear.getDouble("damage-per-second", 1.5)), Math.max(8.0, explosiveNuclear.getDouble("core-shockwave-radius", 100.0)));
